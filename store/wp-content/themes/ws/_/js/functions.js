...
var zoomerAction = '<animate attributeName="viewBox" dur="2s" values="0 0 500 300; 0 0 250 150" fill="freeze" />';

$('#zoom').click(function(event) {
  	event.preventDefault();	
  	//console.log(zoomerAction);
  	//document.getElementById('zoomer-action').innerHTML = zoomerAction;	
  	console.log(document.getElementById('project-drawing').getAttribute('viewBox'));
  	document.getElementById('project-drawing').setAttribute('viewBox','0 0 250 150');  
    //$('.zoomer-viewport').addClass('toggled');		
});		
...
function doAjaxRequest(){
	$.ajax({
	    type: "GET",
	    url: "http://work-shop.ws/wp-admin/admin-ajax.php",
	    dataType: 'html',
