		...
		<div class="container">	
			<div class="row section-body">
				<div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1">
					<h1 class=" bold white">Work-Shop is a research, design, and <br/> fabrication studio in Providence.</h1>
				</div>	
				<div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1">
					<h2 class=" bold white"><a href="mailto:info@workshopri.com" class="white underline">Get in touch with us.</a></h1>
				</div>	
			</div>	
