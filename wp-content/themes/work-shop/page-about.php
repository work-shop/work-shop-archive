...
<div id="about" class="template about">	
	...
	<section id="about-introduction" class="about-introduction introduction block crop three-quarter padded">	
		...
		<div class="block-background" style="background-image: url('<?php bloginfo('template_directory'); ?>/_/img/sketching.jpg')">
		</div>
	...
	<section id="about-mission" class="about-1 block padded bg-light">	
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-3 question hidden">
	...
	<section id="about-values" class="about-3 about-process block padded bg-light">	
		...
		<div class="container">
			<div class="row m90">
				...
				<div class="col-sm-2 question hidden">
	...
	<section id="about-people" class="info-people people block bg-white padded">	
	...
	<section id="about-services" class="about-2 block padded">	
	...
	<section id="about-place" class="about-5 block crop three-quarter bg-light">	
		...
		<div class="row">
			<div class="col-sm-3">	
				...
				<div id="about-nav" class="spy falloff">
					<ul>
						<li><a href="#about-introduction" class="jump hidden"></a></li>					
